...
const SliderOne = () => {
  ...
  return (
    <section className="main-slider">
      <Swiper
        {...mainSlideOptions}
        onInit={() => setTimeout(() => setAnimate(true), 250)}
      >
        <div
          className={animate ? 'swiper-slide-active' : ''}
          style={{
            position: 'absolute',
            top: '0px',
            height: '100vh',
            ...
            <Row>
              <Col lg={12} className="text-center">
                <p className={'main-slider__subtext'}>
                  {SliderOneData[0].subTitle}
                </p>
                <h3 className={'main-slider__title'}>
                  {SliderOneData[0].title}
                </h3>
                <h3 style={{ color: 'white' }}>{SliderOneData[0].subTitle2}</h3>
                <h3 style={{ color: 'white' }}>{SliderOneData[0].subTitle3}</h3>

...
export const CoursesList = {
    ...
    courses: [
    {
        ...
        secondDescription:[<p>El enfoque práctico de la metodología utilizada durante el curso, te permitirá aplicar los conocimientos aprendidos para desarrollar un proyecto que formará parte de tu carta de presentación ante las empresas.</p>,
                            ...
                            <br/>,
                            <p>Aprenderás en grupos reducidos, con atención personalizada y una metodología práctica con un proyecto de desarrollo que será tu carta de presentación ante las empresas.</p>,
                            <p>Adquirirás sólidos conocimientos en el desarrollo de aplicaciones web usando los distintos lenguajes de programación, necesarios para formar parte de una industria en constante expansión.</p>,
                            <p>Aprenderás de grandes profesionales en el desarrollo de Aplicaciones Web que guiarán de cerca tu formación y fomentarán tu talento</p>,
                            ...
                            <br/>,
                            <p>Al finalizar tendrás un perfil diferencial que potenciará tu inserción en el mercado laboral de forma cualificada y competente.</p>
                            ]
    },
    {
        ...
        secondDescription:[<p>Una maestría en programación web brinda al profesional los conocimientos necesarios para convertirse en desarrollador web para cualquier sistema operativo.</p>,
                            ...
                            <p>Un desarrollador web siempre será necesario en esta época, en la que lo digital es la regla. Con este máster, el profesional desarrollará y/ó reforzará sus conocimientos en el desarrollo web.</p>,]
    },
    {
        ...
        secondDescription:[
            ...
            <h1>Objetivos</h1>,
            <p>Los objetivos didácticos de este curso son los siguientes: aprender a desarrollar aplicaciones web sofisticadas de forma ágil y eficaz.</p>,
            <p>Pero nuestro principal objetivo es la empleabilidad, haciéndote alcanzar tus metas profesionales y tu incorporación de lleno a un mercado laboral con múltiples posibilidades para este perfil.</p>,
            <h2>¿POR QUÉ ELEGIR ESTA PROFESIÓN?</h2>,
            <p>Los desarrolladores Backend deben conocer los lenguajes de programación, las librerías y frameworks más utilizados en este tipo de desarrollos. Cada vez es más común que también tengan conocimientos en Frontend, ya que cada vez se requiere este perfil para desarrollar aplicaciones completas</p>,
            <p>Los programadores web continúan siendo uno de los profesionales tecnológicos más demandados en el mercado laboral español. Una demanda que las empresas no logran cubrir por falta de trabajadores especializados y que, además, se incrementa cada año. Todo ello, ha llevado a que los salarios de los profesionales tecnológicos se encuentren entre los que más rápidamente crecen pues para captar talento muchas compañías recurren a aumentos salariales.</p>
        ]
    },
    {
        ...
        secondDescription:[
            ...
            <p>Coder Crack School ofrece un curso de desarrollo web front-end actual y diseñado para enseñarte rápidamente a programar o a cambiar de carrera. Obtendrás todas las habilidades necesarias para conseguir tu primer trabajo como web developer front-end. No se requiere experiencia en absoluto, puedes empezar hoy.</p>,
            <p>Al adquirir nuevas habilidades, sabemos que la idoneidad y el coste de la formación son importantes para ti. Por lo que hemos hecho que la programación de este curso sea muy flexible junto con precios competitivos y múltiples opciones de pago.</p>,
            <h4>¿El objetivo final? ¡Ayudarte a conseguir tu primer trabajo como desarrollador web front-end!</h4>,
            <p>Obtén más información sobre nuestro curso de desarrollo web front-end. ¡Si te inscribes hoy, te convertirás inmediatamente en parte de nuestra familia Coder Crack y te ayudaremos a alcanzar todas tus metas profesionales! Elija entre realizar el curso en un campus de manera presencial o de forma remota, según tus necesidades.</p>,
            <p>Nuestro curso de desarrollador web front-end se basa principalmente en la práctica. Aprenderás a desarrollar sitios web interactivos con CSS, HTML, JavaScript y otras tecnologías y frameworks modernos como React o NodeJS. Tratamos todos los conocimientos fundamentales y habilidades necesarias para que te conviertas en un experto del desarrollo web front-end. Al final del curso, podrás diseñar fantásticas aplicaciones web y fáciles de usar. Nuestros programas incluyen ejercicios reales. Adquirirás rápidamente los conceptos básicos del desarrollo web front-end para que puedas comenzar en tu primer trabajo y destacar. Nuestros horarios también son flexibles, hay opciones de formación disponibles entre semana y los fines de semana.</p>,
    ...
    },
    {
        ...
        secondDescription:[
            ...
            <p>El curso está dirigido a cualquier persona interesada en el mundo de la programación del lado del servidor, Back-end.</p>,
        ]
    }
    ],
    tabs:[

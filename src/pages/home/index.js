									...
									>
										<ul className='navbar-nav nav lavalamp ml-auto menu'>
											...
											<li className='nav-item single_nav'>
												<a href='courses-2.html' className='nav-link'>
													Courses
												</a>
											</li>
											<li className='nav-item single_nav'>
												<a
													href='teachers-3.html'
													className='nav-link dropdown_icon'
												>
													Teachers
												</a>
											</li>
											<li className='nav-item single_nav'>
												<a href='event-list-2.html' className='nav-link'>
													Events
												</a>
											</li>
											<li className='nav-item single_nav'>
							...
							<div className='col-12 col-sm-12 col-md-12 col-lg-12'>
								<div className='title'>
									...
									<p>
										...
										qui similique sunt in culpa qui officia deserunt mollitia
										animi
									</p>
								</div>
							</div>
											...
											<figure>
												<div className='member-img'>
													<div className='teachars_pro'>
														<img
															src='assets/images/team/person9.jpg'
															alt='member img'
															className='img-fluid'
														/>
													</div>
										...
										>
											<figure>
												<div className='member-img'>
													<div className='teachars_pro'>
														<img
															src='assets/images/team/person5.jpg'
															alt='member img'
															className='img-fluid'
														/>
													</div>
										...
										>
											<figure>
												<div className='member-img'>
													<div className='teachars_pro'>
														<img
															src='assets/images/team/person8.jpg'
															alt='member img'
															className='img-fluid'
														/>
													</div>
										...
										>
											<figure>
												<div className='member-img'>
													<div className='teachars_pro'>
														<img
															src='assets/images/team/person7.jpg'
															alt='member img'
															className='img-fluid'
														/>
													</div>
					...
					<div className='container'>
						<div className='row'>
							...
							<div className='col-12 col-sm-12 col-md-12 col-lg-12'>
								<div
									id='sponsored_logos'
									className='owlCarousel sponsored_compani_logos'
								>
									<img
